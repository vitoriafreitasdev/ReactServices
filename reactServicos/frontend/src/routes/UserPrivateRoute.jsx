...
const UserPrivateRoute = () => {
  ...
  return (
      <div>
          ...
          {user?._id === "68839c7f6c586bbc21280f9f" ? <buttom className="adminPanel-btn"><NavLink to={`/administration/${user._id}`} className="admin-link">Painel administrativo</NavLink></buttom> : ""}
          <div className="div-container">
            {user ? (
              ...
              <>
                <p>Acesso negado</p>
                <p>Faça login <button onClick={navigator}>aqui</button></p>
              </>
          )}
